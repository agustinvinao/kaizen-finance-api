CREATE MATERIALIZED VIEW phases_ticks_1w AS
WITH pivots AS (
...
CREATE INDEX phases_ticks_1w_symbol_phase_number ON phases_ticks_1w (symbol, phase_number);

		
REFRESH MATERIALIZED VIEW phases_ticks_1w;
DROP MATERIALIZED VIEW phases_ticks_1w;