CREATE VIEW ticks_on_steroids_4h AS
...
directions AS (
	...
	FROM ticks_4h t LEFT JOIN pivot_types_crossing pc ON t.symbol = pc.symbol AND t.dt = pc.dt
)
...
-- REFRESH VIEW ticks_on_steroids_4h;
-- DROP VIEW ticks_on_steroids_4h;
