CREATE MATERIALIZED VIEW phases_ticks_1h AS
WITH pivots AS (
...
CREATE INDEX phases_ticks_1h_symbol_phase_number ON phases_ticks_1h (symbol, phase_number);

		
REFRESH MATERIALIZED VIEW phases_ticks_1h;
DROP MATERIALIZED VIEW phases_ticks_1h;