...
def get_engine():
    ...
    config = {
        ...
        "MQTT_PASSWORD": "LnDVrRbD7azXwQ@5#tj7RzKwsB",
        "MQTT_USER": "kraizenbrain",
        "MQTT_HOST": "10.0.0.26"
    }
    return create_engine(f"postgresql://{config['DB_USER']}:{config['DB_PASSWORD']}@{config['DB_HOST']}:5432/{config['DB_NAME']}", echo=False)
