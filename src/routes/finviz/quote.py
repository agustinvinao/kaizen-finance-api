...
@finviz.route(
    f"/{api_path}/{module_path}/{submodule_path}/ticker_description/<symbol>",
    methods=["GET"],
)
...
@finviz.route(
    f"/{api_path}/{module_path}/{submodule_path}/ticker_fundament/<symbol>",
    methods=["GET"],
)
...
@finviz.route(
    f"/{api_path}/{module_path}/{submodule_path}/ticker_outer_ratings/<symbol>",
    methods=["GET"],
)
def ticker_outer_ratings(symbol):
    if request.method == "GET":
        ...
        ticker_outer_ratings["Date"] = ticker_outer_ratings["Date"].dt.strftime(
            "%Y-%m-%d %H:%M:%S"
        )
...
@finviz.route(
    f"/{api_path}/{module_path}/{submodule_path}/ticker_inside_trader/<symbol>",
    methods=["GET"],
)
...
@finviz.route(
    f"/{api_path}/{module_path}/{submodule_path}/ticker_news/<symbol>", methods=["GET"]
)
