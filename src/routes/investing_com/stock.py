...
@investing_com.route(f"/{api_path}/{module_path}/{submodule_path}/<country>/<symbol>", methods=["GET"])
def stock(country, symbol):
    if request.method == "GET":
        stock_information = investpy.stocks.get_stock_information(stock=symbol, country=country)
